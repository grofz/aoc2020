...
!
  ...
  integer(4), intent(in), optional :: mode ! (1=Hoare, 2=Lomuto) 
  integer(4), parameter :: MODE_DEF = 1
  integer(4) :: mode_use
...
! ---------------------------------------------------------------------------
  integer(4), intent(inout) :: A(:)
  integer(4), intent(in)    :: lo, hi
  integer(4)                :: hoare_partition

  integer(4) :: itmp, Apiv, i, j
...
! ---------------------------------------------------------------------------
  integer(4), intent(inout) :: A(:)
  integer(4), intent(in)    :: lo, hi
  integer(4)                :: lomuto_partition

  integer(4) :: i, j, Apiv, mi
